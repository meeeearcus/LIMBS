...
5. Safely eject the S-4 and load "%s-LIMB" on the device.
`, projectName, projectVersion, minFirmware, assumption, zipFilename, projectName, projectName, projectName)
}
